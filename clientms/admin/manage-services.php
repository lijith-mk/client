									     ...
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       <td><?php  echo htmlentities($row->ServiceName);?></td>
									        ...
									        <td><a href="edit-services-details.php?editid=<?php echo $row->ID;?>" class="btn btn-primary">Edit</a>
<a href="manage-services.php?delid=<?php echo $row->ID;?>" class="btn btn-danger"  onclicl="return confirm('Do you really want to delete?');">Delete</a>
