									     ...
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       <td><?php  echo htmlentities($row->AccountID);?></td>
									        ...
									        <td><a href="edit-client-details.php?editid=<?php echo $row->ID;?>" class="btn btn-primary btn-sm" target="blank">Edit</a>    <a href="add-client-services.php?addid=<?php echo $row->ID;?>" class="btn btn-warning btn-sm">Assign Services</a></td>
									     </tr>
									     <?php $cnt=$cnt+1;}} ?>
									     </tbody> </table> 
							</div>
