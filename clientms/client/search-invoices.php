									     ...
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       ...
									       <td><?php  echo htmlentities($row->CompanyName);?></td>
									        ...
									        <td><a href="view-invoice.php?invoiceid=<?php  echo $row->BillingId;?>" target="_blank" class="btn btn-primary">View</a></td>
									     </tr>
									     <?php $cnt=$cnt+1;}} else{ ?>
									     	<tr>
									     		<th colspan="6" style="color:red !important; font-size:15px;">No Record Found</th>
									     	</tr>
